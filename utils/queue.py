    ...
    while True:
        ...
        async with sem:
            ...
            if error:
                ...
                preview_link = link.replace("open", "preview")
                download_link = link
                new_text = (
...
def add_to_queue(user_id, file_path, filename, folder_id, reply_func, email=None):
    ...
    user_queues[user_id].put_nowait((task_id, file_path, filename, folder_id, reply_func, start_time, email))
    return task_id
